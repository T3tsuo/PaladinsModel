...
async def main():
    ...
    teamcolumns1 = ["id", "WinTeam", "cwinrate1", "cwinrate2", "cwinrate3",
                   "cwinrate4", "cwinrate5", "ckda1", "ckda2", "ckda3", "ckda4", "ckda5", "cdf1", "cdf2", "cdf3",
                   "cdf4", "cdf5", "cwinrate6", "cwinrate7", "cwinrate8",
    ...
    async for match in matches:
        try:
            ...
            team1data.loc[0] = [match.id, match.winning_team - 1, cwinrate1[0], cwinrate1[1], cwinrate1[2], cwinrate1[3],
                                cwinrate1[4], ckda1[0], ckda1[1], ckda1[2], ckda1[3], ckda1[4],
                                cdf1[0], cdf1[1], cdf1[2], cdf1[3], cdf1[4], cwinrate2[0],
                                cwinrate2[1], cwinrate2[2], cwinrate2[3], cwinrate2[4], ckda2[0], ckda2[1],
                                ckda2[2], ckda2[3], ckda2[4], cdf2[0], cdf2[1], cdf2[2], cdf2[3], cdf2[4]]
