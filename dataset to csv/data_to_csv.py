...
async def main():
    async with arez.PaladinsAPI(DEV_ID, AUTH_KEY) as api:
        matches = api.get_matches_for_queue(arez.Queue.Casual_Siege, start=datetime.fromisoformat('2021-06-16'),
                                            end=datetime.fromisoformat('2021-06-17'), language=None, reverse=False,
